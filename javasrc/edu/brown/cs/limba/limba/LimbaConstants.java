...
enum LimbaToolSet {
   ...
   DEBUG,               // debugging only (evaluate, stack with variables)
   STACK,               // stack access (w/o variables)
   DIAD,                // diad (execution tools
   FAIT,                // diad with only fait analysis, no execution
}
...
String NO_RESPONSE = "*** No response from LLM ***";
